...
exports.getTeachers = async (req, res) => {
  try {
    const teachers = await Teacher.find()
      .select('name title phone email specialization students rating classesToday classesCompleted status performance punctuality completionRate userId passwordChanged createdAt updatedAt')
      .sort({ createdAt: -1 });
